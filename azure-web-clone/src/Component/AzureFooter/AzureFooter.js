...
import './AzureFooter.css'
import azureA from '/home/sha/Documents/React Web Clone/azure-clone/src/Component/assets/img/azureA.svg'
import twitter from '/home/sha/Documents/React Web Clone/azure-clone/src/Component/assets/img/tweet.svg'
import instagram from '/home/sha/Documents/React Web Clone/azure-clone/src/Component/assets/img/insta.svg'
import linkedIn from '/home/sha/Documents/React Web Clone/azure-clone/src/Component/assets/img/link.svg'



export default function AzureFooter() {
  return (
   <>
    <div className="azure-footer">
        <div className="social-media">
          <a href='' className="get-azure-mobile-app">
            <img src={azureA} alt=''/>
            <span>Get the Azure mobile app</span>
          </a>
          <ul className="social-app-list">
            <li>
              <img src={twitter} alt=''/>
            </li>
            <li>
